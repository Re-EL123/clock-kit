...
const STEPS = {
  ...
  ORG_OWNER: [
    ...
    { view: 'leave', title: 'Leave', body: 'See every leave request. Approve or reject waiting requests here.' },
    { view: 'approvals', title: 'Approvals', body: 'Attendance time corrections wait here. Leave is decided on Leave.' },
  ...
  PLATFORM_ADMIN: [
    ...
    { view: 'outreach', title: 'Outreach', body: 'Work the Sandton list in order. Open Draft to copy a one-organisation email, then mark Contacted. Import the Sandton list if the table is empty.' },
    { view: 'profile', title: 'Account', body: 'Add a phone number so we can reach you.' },
